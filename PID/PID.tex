...
\begin{eqnarray}
  ...
  \label{eq:PID_r_t}
\end{eqnarray}
% \begin{itembox}[l]{式(\ref{eq:PID_y_t})の問題点と修正案}
%   式(\ref{eq:PID_y_t})では、CPUの余力を表す指標として$\frac{C^{\rm max}}{C_{N_{\rm UE}}(T)}$、メモリの余力を表す指標として$\frac{M^{\rm max}}{M_{N_{\rm UE}}(T)}$を用いている。ここでの余力とは、現状収容しているUE台数に対する、追加で収容可能なUE台数の割合である。
%
%   式(\ref{eq:PID_y_t})の問題点は、各指標の分母が小さい値をとると、制御が著しく不安定になることである。例えば、あるタイムステップでCPU使用率が0になったとすると、$\frac{C^{\rm max}}{C_{N_{\rm UE}}(T)}$が無限大に発散するため、Idleタイマを減少させる向きに無限の力でPID制御が働くことになる。このような問題を解消するために、式\ref{eq:PID_y_t2}に示すように$y(t)$の式を変更することを考えている。
%   \begin{eqnarray}
%     y(t) &=& (CPU使用率) - (メモリ使用率)
%     \nonumber\\
%      &=& \frac{C_{N_{\rm UE}}(T)}{C^{\rm max}} - \frac{M_{N_{\rm UE}}(T)}{M^{\rm max}}
%     \label{eq:PID_y_t2}
%   \end{eqnarray}
% \end{itembox}
...
これらの結果を見ると$\alpha$の値が小さい場合、短い周期でのIdleタイマが変動が安定することがわかる。
...
\clearpage
実用PID制御における微分係数$\eta$の値を様々に変化させて実験を行った。
結果を以下の図\ref{fig:result_pid_practice_0.3}、\ref{fig:result_pid_practice_0.6}、\ref{fig:result_pid_practice_1}に示す。
これらの結果を見ると$\eta$の値が大きい場合、小さい周期でのIdleタイマの変動が安定することがわかる。
一方で、オーバシュートの発生により、周期の大きな変動が発生していることがわかる。
...
\begin{figure}[htbp]
 ...
 \begin{subfigure}{0.49\hsize}
   \centering
   \includegraphics[width=1.0\hsize]{scenario_5_e_86400_345600_0-318_3725_931-25_0-3_practice.pdf}
   \subcaption{$e(t)$の変化}
   \label{subfig:scenario_5_e_86400_345600_0-318_0-318_3725_931-25_0-3_practice}
 \end{subfigure}
 \begin{subfigure}{0.49\hsize}
   \centering
   \includegraphics[width=1.0\hsize]{scenario_5_idleTimer_86400_345600_0-318_3725_931-25_0-3_practice.pdf}
   \subcaption{IdleTimerの変化}
   \label{subfig:scenario_5_idleTimer_86400_345600_0-318_3725_931-25_0-3_practice}
 \end{subfigure}
 \par\bigskip %改行
 \begin{subfigure}{0.49\hsize}
   \centering
   \includegraphics[width=1.0\hsize]{scenario_5_signaling_and_memoryload_vs_timeStep_86400_345600_0-318_3725_931-25_0-3_practice.pdf}
   \subcaption{CPU負荷とメモリ使用量の変化}
   \label{subfig:scenario_5_signaling_and_memoryload_vs_timeStep_86400_345600_0-318_3725_931-25_0-3_practice}
 \end{subfigure}
 \begin{subfigure}{0.49\hsize}
   \centering
   \includegraphics[width=1.0\hsize]{scenario_5_stateBreakdown_86400_345600_0-318_3725_931-25_0-3_practice.pdf}
   \subcaption{各状態にあるUE台数の変化}
   \label{subfig:scenario_5_stateBreakdown_86400_345600_0-318_3725_931-25_0-3_practice}
 \end{subfigure}
 \caption{実用PID($K_p = 0.318、K_i = 0.0000854、K_d = 296.14、\eta = 0.3$)}
 \label{fig:result_pid_practice_0.3}
\end{figure}
...
\begin{figure}[htbp]
 ...
 \begin{subfigure}{0.49\hsize}
   \centering
   \includegraphics[width=1.0\hsize]{scenario_5_e_86400_345600_0-318_3725_931-25_0-6_practice.pdf}
   \subcaption{$e(t)$の変化}
   \label{subfig:scenario_5_e_86400_345600_0-318_0-318_3725_931-25_0-6_practice}
 \end{subfigure}
 \begin{subfigure}{0.49\hsize}
   \centering
   \includegraphics[width=1.0\hsize]{scenario_5_idleTimer_86400_345600_0-318_3725_931-25_0-6_practice.pdf}
   \subcaption{IdleTimerの変化}
   \label{subfig:scenario_5_idleTimer_86400_345600_0-318_3725_931-25_0-6_practice}
 \end{subfigure}
 \par\bigskip %改行
 \begin{subfigure}{0.49\hsize}
   \centering
   \includegraphics[width=1.0\hsize]{scenario_5_signaling_and_memoryload_vs_timeStep_86400_345600_0-318_3725_931-25_0-6_practice.pdf}
   \subcaption{CPU負荷とメモリ使用量の変化}
   \label{subfig:scenario_5_signaling_and_memoryload_vs_timeStep_86400_345600_0-318_3725_931-25_0-6_practice}
 \end{subfigure}
 \begin{subfigure}{0.49\hsize}
   \centering
   \includegraphics[width=1.0\hsize]{scenario_5_stateBreakdown_86400_345600_0-318_3725_931-25_0-6_practice.pdf}
   \subcaption{各状態にあるUE台数の変化}
   \label{subfig:scenario_5_stateBreakdown_86400_345600_0-318_3725_931-25_0-6_practice}
 \end{subfigure}
 \caption{実用PID($K_p = 0.318、K_i = 0.0000854、K_d = 296.14、\eta = 0.6$)}
 \label{fig:result_pid_practice_0.6}
\end{figure}
...
\begin{figure}[htbp]
 ...
 \begin{subfigure}{0.49\hsize}
   \centering
   \includegraphics[width=1.0\hsize]{scenario_5_e_86400_345600_0-318_3725_931-25_1_practice.pdf}
   \subcaption{$e(t)$の変化}
   \label{subfig:scenario_5_e_86400_345600_0-318_0-318_3725_931-25_1_practice}
 \end{subfigure}
 \begin{subfigure}{0.49\hsize}
   \centering
   \includegraphics[width=1.0\hsize]{scenario_5_idleTimer_86400_345600_0-318_3725_931-25_1_practice.pdf}
   \subcaption{IdleTimerの変化}
   \label{subfig:scenario_5_idleTimer_86400_345600_0-318_3725_931-25_1_practice}
 \end{subfigure}
 \par\bigskip %改行
 \begin{subfigure}{0.49\hsize}
   \centering
   \includegraphics[width=1.0\hsize]{scenario_5_signaling_and_memoryload_vs_timeStep_86400_345600_0-318_3725_931-25_1_practice.pdf}
   \subcaption{CPU負荷とメモリ使用量の変化}
   \label{subfig:scenario_5_signaling_and_memoryload_vs_timeStep_86400_345600_0-318_3725_931-25_1_practice}
 \end{subfigure}
 \begin{subfigure}{0.49\hsize}
   \centering
   \includegraphics[width=1.0\hsize]{scenario_5_stateBreakdown_86400_345600_0-318_3725_931-25_1_practice.pdf}
   \subcaption{各状態にあるUE台数の変化}
   \label{subfig:scenario_5_stateBreakdown_86400_345600_0-318_3725_931-25_1_practice}
 \end{subfigure}
 \caption{実用PID($K_p = 0.318、K_i = 0.0000854、K_d = 296.14、\eta = 1$)}
 \label{fig:result_pid_practice_1}
\end{figure}
...
\section{今後の予定}
  \begin{itemize}
    \item PID制御の出力値($y(t)$)に関する式を変更した上で、これまで行っていた一連の評価結果を差し替える(次回の報告まで)
